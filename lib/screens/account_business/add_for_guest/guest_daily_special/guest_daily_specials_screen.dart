...
class GuestDailySpecialScreen extends GetView<GuestController> {
  const GuestDailySpecialScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<GuestController>(builder: (_) {
        return Padding(
                    ...
                    onPressed: () {
                      if (controller.sundaydailySpecialType != "" &&
                        ...
                        Get.find<GlobalGeneralController>()
                            .errorSnackbar(title: "Error",description: 'Select Type and Name');
                      }
                    },
                  ),
