...
class BusinessSearchResultScreen
    extends GetView<BusinessSearchResultController> {
  const BusinessSearchResultScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<BusinessSearchResultController>(
        builder: (_) {
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          ...
                          // Get.find<BusinessFilterScreenController>()
                          //         .searchController
                          //         .text
                          //         .isEmpty
                          //     ? Get.toNamed(
                ...
                children: [
                  ...
                  CustomHappyhourSearchCard(
                    ...
                    yellowText: controller.searchItem.isEmpty
                        ? "${controller.hourSearch[index].foodName?[0]['foodname']}: \$${controller.hourSearch[index].foodName?[0]['foodprice']}   ${controller.hourSearch[index].foodName?.last['foodname']}:  \$${controller.hourSearch[index].foodName?.last['foodprice']}"
