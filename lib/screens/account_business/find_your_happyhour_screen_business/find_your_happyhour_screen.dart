            ...
            children: [
              Row(
                children: [
                  ...
                  const Spacer(),
                  GetBuilder<BusinessFindYourHappyHourScreenController>(
                    builder: (con) {
                ...
                return CustomCircleIndicator(
                  ...
                  child: Padding(
                    ...
                    child: controller.locationPermissionStatus !=
                        ...
                        : controller.hoursInRadiusList.isNotEmpty
                            ? ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  //     : '';
                                  String time = controller
                                          .hoursInRadiusList[index].showTime ??
                                      "";
                                  if (index % 4 == 3) {
                                    return Column(
                                      crossAxisAlignment:
