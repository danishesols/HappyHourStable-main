...
class BusinessFindYourHappyHourScreenController extends GetxController {
  ...
  //   int dayIndex = 0;
  //   try {
  //     parsedTime = timeFormat.parse(timePart);
  //     dayIndex = DateTime.daysPerWeek - DateTime.monday;
  //     switch (parts[2]) {
  //       case "Tuesday":
  //         dayIndex = DateTime.tuesday - DateTime.monday;
  //         break;
  //       case "Wednesday":
  //         dayIndex = DateTime.wednesday - DateTime.monday;
  //         break;
  //       case "Thursday":
  //         dayIndex = DateTime.thursday - DateTime.monday;
  //         break;
  //       case "Friday":
  //         dayIndex = DateTime.friday - DateTime.monday;
  //         break;
  //       case "Saturday":
  //         dayIndex = DateTime.saturday - DateTime.monday;
  //         break;
  //       case "Sunday":
  //         dayIndex = DateTime.sunday - DateTime.monday;
  //         break;
  //     }
  //   } catch (e) {
  //     print(e);
  //   }
  //   DateTime parsedDateTime = DateTime(now.year, now.month, now.day + dayIndex,
  ...
  //     element.day?.forEach((element) {
  //       String hFromTime = hFromTimeWithDay(element);
  //       String hToTime = hToTimeWithDay(element);
  //       DateTime parsedHFromTime = parseTimeString(hFromTime);
  //       DateTime parsedHToTime = parseTimeString(hToTime);
  //       String happyHourDay = DateFormat('EEEE').format(parsedHFromTime);
  //       if (dayOfWeek == happyHourDay) {
  //         print(
  //             "$happyHourDay Start Hour  ${parsedHFromTime.hour} end Hour ${parsedHToTime.hour}");
  //       }
  //     });
  //   });
  // }
  //
  // String hFromTimeWithDay(element) =>
  //     element['HfromTime'].toString() + " " + element['Hday'];
  // String hToTimeWithDay(element) =>
  //     element['HtoTime'].toString() + " " + element['Hday'];

  newFilter() {
    print("Find Happy Hour Business");
    Set<HappyHourModel> _temp = {};
    DateTime now = DateTime.now();
    String dayOfWeek = DateFormat('EEEE').format(now);
  ...
  Future<void> onInit() async {
    isLoading = true;
    update();
    // if (CurrentLocationController.latitude == null ||
    //     CurrentLocationController.longitude == null) {
