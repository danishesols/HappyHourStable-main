...
class BusinessAmenitiesScreen extends GetView<AddHappyhourBusinessController> {
  const BusinessAmenitiesScreen({Key? key}) : super(key: key);
      ...
      bottomNavigationBar: Padding(
        ...
        child: SizedBox(
          ...
          child: CustomElevatedButtonWidget(
            onPressed: () {
              Get.toNamed(Routes.businessBarTypeScreen);
            },
            text: "Next",
