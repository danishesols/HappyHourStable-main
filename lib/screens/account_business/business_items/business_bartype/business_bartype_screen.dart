...
class BusinessBarTypeScreen extends GetView<AddHappyhourBusinessController> {
  const BusinessBarTypeScreen({Key? key}) : super(key: key);
        ...
        child: SizedBox(
          ...
          child: CustomElevatedButtonWidget(
            onPressed: () {
              ...
              if (a <= 3 && a > 0) {
                Get.toNamed(Routes.businessEventsScreen);
              }
            },
            text: "Next",
