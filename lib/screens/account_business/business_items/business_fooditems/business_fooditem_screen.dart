...
class BusinessFoodItemScreen extends GetView<AddHappyhourBusinessController> {
  const BusinessFoodItemScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<AddHappyhourBusinessController>(
        builder: (_) {
          return Padding(
              ...
              child: Padding(
                ...
                child: ListView(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: W * 0.06, right: 3),
                      child: Row(
