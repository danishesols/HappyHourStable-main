...
class AddHappyHourEventsScreen extends GetView<AddHappyhourController> {
  const AddHappyHourEventsScreen({Key? key}) : super(key: key);
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: CustomElevatedButtonWidget(
                            onPressed: () {
                              if (controller.eventKey.currentState!
                                      .validate() ==
                                  false) {
