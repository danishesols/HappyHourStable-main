...
class AddHappyHourAmenitiesScreen extends GetView<AddHappyhourController> {
  const AddHappyHourAmenitiesScreen({Key? key}) : super(key: key);
                              ...
                              () => Card(
                                ...
                                child: Transform.scale(
                                  ...
                                  child: Checkbox(
                                      ...
                                      onChanged: (v) {
                                        controller.amenitiesList[index].isSelect
                                                .value =
      ...
      bottomNavigationBar: Padding(
        ...
        child: SizedBox(
          ...
          child: CustomElevatedButtonWidget(
            onPressed: () {
              Get.toNamed(Routes.addHappyHourBarTypeScreen);
            },
            text: "Next",
