...
class AddHappyHourBarTypeScreen extends GetView<AddHappyhourController> {
  const AddHappyHourBarTypeScreen({Key? key}) : super(key: key);
                            ...
                            () => Card(
                              ...
                              child: Transform.scale(
                                ...
                                child: Checkbox(
                                    ...
                                    onChanged: (v) {
                                      controller.barTypeList[index].isSelect
                                              .value =
            ...
            onPressed: () {
              ...
              if (a == 0) {
                Get.find<GlobalGeneralController>().errorSnackbar(
                    title: "Error", description: "Select atleast One Bar");
              }
              if (a > 3) {
                Get.find<GlobalGeneralController>().errorSnackbar(
