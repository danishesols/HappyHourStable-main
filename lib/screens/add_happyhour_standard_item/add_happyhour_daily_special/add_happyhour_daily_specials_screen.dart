...
class AddHappyDailySpecialScreen extends GetView<AddHappyhourController> {
  const AddHappyDailySpecialScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Get.put(AddHappyhourController());
    return Scaffold(
      ...
      body: GetBuilder<AddHappyhourController>(
        init: AddHappyhourController(),
        builder: (_) {
...
//*if Not Empty dailySpecialItemList ListView Builder Will show Here the food OR Drinks Item
  ...
  /// replace this by business dailyspecial
        ...
        child: CustomElevatedButtonWidget(
          onPressed: () {
            ...
            addNewItemDialog(
              ...
              GetBuilder<AddHappyhourController>(
                builder: (_) {
                  return Column(
                    children: [
                      Card(
              ...
              "Add new item",
                ...
                addMondayManually(
                  ...
                  CustomElevatedButtonWidget(
                    ...
                    text: ("Add"),
                    onPressed: () {
                      if (controller.mondaydailySpecialType != "" &&
                          controller.adddailySpecialManuallyController.text !=
                              "") {
                        controller.addManuallymondayAddTodailySpecialItemList();

                        controller.adddailySpecialManuallyController.clear();
                        controller.mondaydailySpecialType = "";
                        Navigator.pop(context);
                      } else {
                        Get.find<GlobalGeneralController>()
                            .errorSnackbar(description: "Select Type and Name",title:'Error');
                  ...
                  return Column(
                    children: [
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            items: controller.mondaydailySpecialType == "Drinks"
                              ...
                              child: Text(
                                ...
                                .toList()
                                : controller.mondaydailySpecialType == "Foods"
                                ? controller.foo
                                .map((name) => DropdownMenuItem(
                              value: name,
                              child: Text(
                      ...
                      CustomElevatedButtonWidget(
                        onPressed: () {
                          //* add first drop down button
                          if (controller.mondaydailySpecialType != null &&
                              controller.dailSpecialName != null) {
              ...
              "Add new item",
                ...
                addTuesdayManually(
                  ...
                  CustomElevatedButtonWidget(
                    ...
                    text: ("Add"),
                    onPressed: () {
                      if (controller.tuesdaydailySpecialType != "" &&
                          controller.adddailySpecialManuallyController.text !=
                              "") {
                        controller
                        ...
                        controller.adddailySpecialManuallyController.clear();
                        controller.tuesdaydailySpecialType = "";
                        Navigator.pop(context);
                      } else {
                        Get.find<GlobalGeneralController>()
                            .errorSnackbar(description: "Select Type and Name",title:'Error');
                    ...
                    children: [
                      ...
                      Card(
                        ...
                        child: SizedBox(
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            icon: const Icon(Icons.keyboard_arrow_down),
                            items: controller.tuesdaydailySpecialType ==
                                "Drinks"
                                ? controller.dri
                                .map((name) => DropdownMenuItem(
                              value: name,
                              child: Text(
                                ...
                                .toList()
                                : controller.tuesdaydailySpecialType == "Foods"
                                ? controller.foo
                                .map((name) => DropdownMenuItem(
                              value: name,
                              child: Text(
                      ...
                      CustomElevatedButtonWidget(
                        onPressed: () {
                          ...
                          if (controller.tuesdaydailySpecialType != null &&
                              controller.dailSpecialName != null) {
              ...
              "Add new item",
                ...
                addWednesdayManually(
                  ...
                  CustomElevatedButtonWidget(
                    ...
                    text: ("Add"),
                    onPressed: () {
                      if (controller.wednesdaydailySpecialType != "" &&
                          controller.adddailySpecialManuallyController.text !=
                              "") {
                        controller
                        ...
                        Navigator.pop(context);
                        controller.adddailySpecialManuallyController.clear();
                        controller.wednesdaydailySpecialType = "";
                      } else {
                        Get.find<GlobalGeneralController>()
                            .errorSnackbar(description: "Select Type and Name",title:'Error');
                      }
                    ...
                    children: [
                      ...
                      CustomElevatedButtonWidget(
                        onPressed: () {
                          ...
                          if (controller.wednesdaydailySpecialType != null &&
                              controller.dailSpecialName != null) {
              ...
              "Add new item",
                ...
                addThursdayManually(
                  ...
                  CustomElevatedButtonWidget(
                    ...
                    text: ("Add"),
                    onPressed: () {
                      if (controller.thursdaydailySpecialType != "" &&
                          controller.adddailySpecialManuallyController.text !=
                              "") {
                        controller
                            .addManuallythursdayAddTodailySpecialItemList();
                        controller.adddailySpecialManuallyController.clear();
                        controller.thursdaydailySpecialType = "";
                        Navigator.pop(context);
                      } else {
                        Get.find<GlobalGeneralController>()
                            .errorSnackbar(description: "Select Type and Name",title:'Error');
                    ...
                    children: [
                      ...
                      Card(
                        ...
                        child: SizedBox(
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            icon: const Icon(Icons.keyboard_arrow_down),
                            items: controller.thursdaydailySpecialType ==
                                "Drinks"
                                ? controller.dri
                                .map((name) => DropdownMenuItem(
                              value: name,
                              child: Text(
                                ...
                                .toList()
                                : controller.thursdaydailySpecialType == "Foods"
                                ? controller.foo
                                .map((name) => DropdownMenuItem(
                              value: name,
                              child: Text(
                      ...
                      CustomElevatedButtonWidget(
                        onPressed: () {
                          ...
                          if (controller.thursdaydailySpecialType != null &&
                              controller.dailSpecialName != null) {
              ...
              "Add new item",
                ...
                addFridayManually(
                  ...
                  CustomElevatedButtonWidget(
                    ...
                    text: ("Add"),
                    onPressed: () {
                      if (controller.fridaydailySpecialType != "" &&
                          controller.adddailySpecialManuallyController.text !=
                              "") {
                        controller.addManuallyfridayAddTodailySpecialItemList();
                        controller.adddailySpecialManuallyController.clear();
                        controller.fridaydailySpecialType = "";
                        Navigator.pop(context);
                      } else {
                        Get.find<GlobalGeneralController>()
                            .errorSnackbar(description: "Select Type and Name",title:'Error');
                  ...
                  return Column(
                    children: [
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            items: controller.fridaydailySpecialType == "Drinks"
                              ...
                              child: Text(
                                ...
                                .toList()
                                : controller.fridaydailySpecialType == "Foods"
                                ? controller.foo
                                .map((name) => DropdownMenuItem(
                              value: name,
                              child: Text(
                      ...
                      CustomElevatedButtonWidget(
                        onPressed: () {
                          //* add first drop down button
                          if (controller.fridaydailySpecialType != null &&
                              controller.dailSpecialName != null) {
              ...
              "Add new item",
                ...
                addSaturdayManually(
                  ...
                  CustomElevatedButtonWidget(
                    ...
                    text: ("Add"),
                    onPressed: () {
                      if (controller.saturdaydailySpecialType != "" &&
                          controller.adddailySpecialManuallyController.text !=
                              "") {
                        controller
                            .addManuallysaturdayAddTodailySpecialItemList();
                        controller.adddailySpecialManuallyController.clear();
                        controller.saturdaydailySpecialType = "";
                        Navigator.pop(context);
                      } else {
                        Get.find<GlobalGeneralController>()
                            .errorSnackbar(description: "Select Type and Name",title:'Error');
                  ...
                  return Column(
                    children: [
                      ...
                      Card(
                        ...
                        child: SizedBox(
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            icon: const Icon(Icons.keyboard_arrow_down),
                            items: controller.saturdaydailySpecialType ==
                                "Drinks"
                                ? controller.dri
                                .map((name) => DropdownMenuItem(
                              value: name,
                              child: Text(
                                ...
                                .toList()
                                : controller.saturdaydailySpecialType == "Foods"
                                ? controller.foo
                                .map((name) => DropdownMenuItem(
                              value: name,
                              child: Text(
                      ...
                      CustomElevatedButtonWidget(
                        onPressed: () {
                          //* add first drop down button
                          if (controller.saturdaydailySpecialType != null &&
                              controller.dailSpecialName != null) {
...
//                                             ))
//                                         .toList(),
//                             onChanged: controller.saturdaydailySpecialType != null ? (time) {
//                               controller.dailSpecialName = time!;
//                             } : null,
//                           ),
//                         ),
                    ...
                    child: SizedBox(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        onChanged: (time) {
                          ...
                          controller.sundaydailySpecialItemList[x]['fromTime']=time;
                          controller.update();
                    ...
                    child: SizedBox(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        onChanged: (time) {
                          ...
                          controller.sundaydailySpecialItemList[x]['toTime']=time;
                          controller.update();
                        },
                      ),
                    ),
                ...
                Card(
                  ...
                  child: SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (time) {
                        controller.dailySpecialfromtime = time!;
                        controller.mondaydailySpecialItemList[x]['fromTime']=time;
                        controller.update();
                      },
                    ),
                  ),
                ...
                Card(
                  ...
                  child: SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (time) {
                        controller.dailySpecialtotime = time!;
                        controller.mondaydailySpecialItemList[x]['toTime']=time;
                        controller.update();
                      },
                    ),
                  ),
                ...
                Card(
                  ...
                  child: SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (time) {
                        controller.dailySpecialfromtime = time!;
                        controller.tuesdaydailySpecialItemList[x]['fromTime']=time;
                        controller.update();
                      },
                    ),
                  ),
                ...
                Card(
                  ...
                  child: SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (time) {
                        controller.dailySpecialtotime = time!;
                        controller.tuesdaydailySpecialItemList[x]['toTime']=time;
                        controller.update();
                      },
                    ),
                  ),
                ...
                Card(
                  ...
                  child: SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (time) {
                        controller.dailySpecialfromtime = time!;
                        controller.wednesdaydailySpecialItemList[x]['fromTime']=time;
                        controller.update();
                      },
                    ),
                  ),
                ...
                Card(
                  ...
                  child: SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (time) {
                        controller.dailySpecialtotime = time!;
                        controller.wednesdaydailySpecialItemList[x]['toTime']=time;
                        controller.update();
                      },
                    ),
                  ),
                ...
                Card(
                  ...
                  child: SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (time) {
                        controller.dailySpecialfromtime = time!;
                        controller.thursdaydailySpecialItemList[x]['fromTime']=time;
                        controller.update();
                      },
                    ),
                  ),
                ...
                Card(
                  ...
                  child: SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (time) {
                        controller.dailySpecialtotime = time!;
                        controller.thursdaydailySpecialItemList[x]['toTime']=time;
                        controller.update();
                      },
                    ),
                  ),
                ...
                Card(
                  ...
                  child: SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (time) {
                        controller.dailySpecialfromtime = time!;
                        controller.fridaydailySpecialItemList[x]['fromTime']=time;
                        controller.update();
                      },
                    ),
                  ),
                ...
                Card(
                  ...
                  child: SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (time) {
                        controller.dailySpecialtotime = time!;
                        controller.fridaydailySpecialItemList[x]['toTime']=time;
                        controller.update();
                      },
                    ),
                  ),
                ...
                Card(
                  ...
                  child: SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (time) {
                        controller.dailySpecialfromtime = time!;
                        controller.saturdaydailySpecialItemList[x]['fromTime']=time;
                        controller.update();
                      },
                    ),
                  ),
                ...
                Card(
                  ...
                  child: SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (time) {
                        controller.dailySpecialtotime = time!;
                        controller.saturdaydailySpecialItemList[x]['toTime']=time;
                        controller.update();
                      },
                    ),
                  ),
