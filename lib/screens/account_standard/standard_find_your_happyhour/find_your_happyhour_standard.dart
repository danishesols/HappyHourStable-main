...
class StandardFindYourHappyHourScreen
            ...
            children: [
              Row(
                children: [
                  ...
                  const Spacer(),
                  GetBuilder<FindYourHappyHourStandardController>(
                      builder: (con) {
                      ...
                      onTap: controller.isLoading
                          ? () {
                              Get.find<GlobalGeneralController>().infoSnackbar(
                                  title: 'Loading...',
                                  description: 'Let Happy hours load first');
                            }
                          : () {
  ...
  radiusChangerSlider() {
  return GetBuilder<FindYourHappyHourStandardController>(
    builder: (contr) {
      return SfSlider(
           min: 0.0,
           max: 30.0,
