...
class EditDailySpecialScreen extends GetView<EditController> {
  const EditDailySpecialScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<EditController>(builder: (_) {
        return Padding(
        ...
        child: SizedBox(
          ...
          child: CustomElevatedButtonWidget(
            onPressed: () {
              ...
              // print(
              //     'controller.mondaydailySpecialItemList[0][\'fromTime\']: ${controller.mondaydailySpecialItemList[0]['fromTime']}');
              // // controller.addToDailyySpecial();
              // // Get.back();
