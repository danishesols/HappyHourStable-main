...
class EditDrinksScreen extends GetView<EditController> {
  EditDrinksScreen({Key? key}) : super(key: key);
                                ...
                                children: [
                                  ...
                                  PriceField(
                                    ...
                                    onTap: () {
                                      ...
                                      controller
                                          .localdrinkList[index].discount = 0;
                                      controller.update();
                                    },
                                    validator: (val) {
                                      ...
                                      children: [
                                                ...
                                                await Get.find<
                                                    ...
                                                    .infoSnackbar(
                                                        title:
                                                            'No Late Hour Time',
                                                        description:
                                                            'Add at least one Late Happy Hour time');
                                                Get.toNamed(
                                                    Routes.editDayTimeScreen,
                                        ...
                                        Checkbox(
                                            value: controller
                                                ...
                                                .value,
                                            onChanged: (v) async {
                                              if (controller.hDayTimeLateList
                                                  .isNotEmpty) {
                                                controller
                ...
                if (controller.localdrinkList.isEmpty) {
                  ...
                  if (a.isEmpty) {
                    Get.find<GlobalGeneralController>().errorSnackbar(
                        title: "Error",
                        description:
                            "Drink Size and Price/Discount Is Required");
                  }
