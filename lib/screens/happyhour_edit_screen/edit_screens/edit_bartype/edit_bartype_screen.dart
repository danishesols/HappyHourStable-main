...
class EditBarTypeScreen extends GetView<EditController> {
  const EditBarTypeScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {print("bartype");
    return Scaffold(
                  ...
                  return Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(controller.barTypeList[index].name,
