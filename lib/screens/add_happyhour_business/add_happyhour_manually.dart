...
import 'package:happy_hour_app/screens/add_happyhour_standard_item/add_happyhour_controller.dart';
...
class AddHappyHOurManually extends GetView<AddHappyhourController> {
  //const AddHappyHOurManually({super.key});
          ...
          child: CustomElevatedButtonWidget(
            onPressed: () {
              if (controller.manualAddressformKey.currentState!.validate()) {
                Get.offNamed(Routes.addHappyHourBusinessScreen);
              }
            },
            text: "Done",
