...
class ClaimDailySpecialScreen extends GetView<ClaimController> {
  const ClaimDailySpecialScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<ClaimController>(builder: (_) {
        return Padding(
