...
class DuplicateBusinessHourScreen extends GetView<DuplicateController> {
  const DuplicateBusinessHourScreen({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Form(
              key:controller.businessHourKey,
