...
class DuplicateDayTimeScreen extends GetView<DuplicateController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DuplicateController>(builder: (controller) {
      print(controller.firestoreObj.day!.length);
      return Scaffold(
              ...
              child: Padding(
                ...
                child: ListView(
                  children: [
                                    ...
                                    child: Obx(
                                      () => DropdownButtonFormField<String>(
                                        ...
                                        onChanged: (fromTime) {
                                          controller.dayTimeList[index]
                                              .fromTime = fromTime!;
                                          controller.hDayTime(index, controller.dayTimeList[index].day);
                                        },
                                      ),
                                    ),
                                  ),
                    ...
                    controller.firestoreObj.dayLate!.isNotEmpty || controller.showLate
                        ? const Padding(
                      padding: EdgeInsets.only(left: 8.0),
                      child: Text(
                        ...
                        child: const Text("Show Late Happy Hour",
                          style: TextStyle(
                              fontSize: 20,
                              fontWeight: FontWeight.w700,
                              color: primary
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: Obx(
                                          ...
                                          controller.dayTimeList2[index]
                                              .fromTime2 = fromTime!;
                                          controller.hDayTimeLate(index,  controller.dayTimeList2[index].day);
                                              },
                                            ),
                                        ),
                                      ),
