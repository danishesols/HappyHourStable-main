...
class DuplicateDrinksScreen extends GetView<DuplicateController> {
  const DuplicateDrinksScreen({Key? key}) : super(key: key);
                            ...
                            Obx(
                              () => Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Checkbox(
                                        value: controller.localdrinkList[index]
                                            .earlyDrink.value,
                                        onChanged: (v) async {
                                          if (controller
                                    ...
                                    Checkbox(
                                        ...
                                        onChanged: (v) async {
                                          if (controller
                                            ...
                                            controller.showLateTimeDrink(index);
                                          } else {
                                            await Get.find<
                                                    GlobalGeneralController>()
                                                .infoSnackbar(
                            ...
                            () {
                              ...
                              addDrinksManually(
                                ...
                                CustomElevatedButtonWidget(
                                    ...
                                    text: ("Add"),
                                    onPressed: () {
                                      if (controller.addDrinksManuallyController
                                          .text.isNotEmpty) {
